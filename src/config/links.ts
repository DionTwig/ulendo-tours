// Centralised outbound links. Swap real values here when they change —
// nowhere else in the codebase should hardcode a URL.
export const links = {
  whatsapp: {
    base: "https://wa.me/27799569295",
  ...
  email: "mailto:bookings@ulendotours.co.za",
  instagram: "https://www.instagram.com/ulendotours.co.za",
  facebook: "https://www.facebook.com/share/1LP1Y2r1n7/",
  viator: "#", // still pending — see Launch Blockers
} as const;
